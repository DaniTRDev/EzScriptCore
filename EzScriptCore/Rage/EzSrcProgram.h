...
namespace Ez
{
	...
	namespace rage
	{
		...
		struct scrProgramHeaderPC
		{
			...
			std::uint32_t			m_GlobalsVersion;
			std::uint32_t			m_CodeLength;
			std::uint32_t			m_ParameterCount;
			std::uint32_t			m_StaticsCount;
			std::uint32_t			m_GlobalsCount;
			std::uint32_t			m_NativesCount;
	...
	struct EzSrcProgram
	{
		...
		rage::RageResourceVersion		m_ScriptVersion;
